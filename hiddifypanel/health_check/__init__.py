...
def init_app(app) -> None:
    ...
    @app.route('/<health_path>/ip/<int:ip_id>', methods=['GET'])
    def health_check_ip(_health_path: str, ip_id: int):
        child_id = g.child.id if getattr(g, 'child', None) else 0
