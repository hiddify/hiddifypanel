...
from hiddifypanel.models import CustomProxyMode, L7Proto, TemplateCategory, TEMPLATE_CATEGORIES_ACTIVE
...
class ClientCoreConfigSchema(Schema):
    ...
    do_base64_after = fields.Boolean(load_default=False)
    template_slugs = fields.List(fields.String(), load_default=list)
