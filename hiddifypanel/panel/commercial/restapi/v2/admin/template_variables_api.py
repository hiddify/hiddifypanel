...
from hiddifypanel.hutils.proxy.template_variables import build_template_variables

from .custom_proxy_schema import TemplateVariableGroupsSchema
...
class TemplateVariablesApi(MethodView):
    ...
    @app.output(TemplateVariableGroupsSchema)  # type: ignore
    def get(self):
