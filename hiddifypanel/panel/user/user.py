    ...
    def singbox_ssh_imp(self):
        ...
        if request.method == "HEAD":
            ...
            resp = render_template(
                "singbox_config.json", **c, host_keys=hutils.proxy.get_ssh_hostkeys(get_hconfigs_json()), ssh_client_version=hiddify.get_ssh_client_version(g.user), ssh_ip=hutils.network.get_direct_host_or_ip(4), base64=False
            )
