...
EXTRA_PROXY_ROWS: list[dict[str, Any]] = [
    ...
    {'l3': 'tls', 'transport': 'custom', 'cdn': 'direct', 'proto': 'tuic', 'name': 'TUIC'},
    {'l3': 'tls', 'transport': 'custom', 'cdn': 'relay', 'proto': 'tuic', 'name': 'TUIC Relay'},
    {'l3': 'tls', 'transport': 'custom', 'cdn': 'direct', 'proto': 'hysteria2', 'name': 'Hysteria2'},
    {'l3': 'tls', 'transport': 'custom', 'cdn': 'relay', 'proto': 'hysteria2', 'name': 'Hysteria2 Relay'},
