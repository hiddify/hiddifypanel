...
def build_usage_summary(
    ...
    return {
        "series": [{"date": point.day.isoformat(), "usage": point.usage, "online": point.online} for point in series],
        "totals": {
            "today": today_usage,
        ...
        "peak": {"date": peak.day.isoformat(), "usage": peak.usage} if peak and peak.usage else None,
    }
