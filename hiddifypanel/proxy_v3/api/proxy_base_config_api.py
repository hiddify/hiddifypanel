...
from hiddifypanel.proxy_v3.custom_proxy_validate import preview_base_config_content, validate_base_config_content
...
class ProxyBaseConfigsApi(MethodView):
    ...
    def get(self):
        ...
        q = ProxyBaseConfig.query.filter((ProxyBaseConfig.child_id == _child_id()) | (ProxyBaseConfig.child_id == 0))
        if side:
            try:
