import{B as g,s as v,aq as c,ar as a,W as y,o as d,c as p,i,a as u,r as B,D as M,F as L,l as w,C as D,n as x,d as m,_ as z}from"./index.js";var F=`
...
`));return(s,l)=>(d(),p("div",k,[i("table",C,[i("tbody",null,[(d(!0),p(L,null,w(r.value,(n,o)=>(d(),p("tr",{key:o,class:x({"line-numbered-code__row--highlight":t.highlightLine===o+1})},[i("td",P,m(o+1),1),i("td",K,[i("code",null,m(n||" "),1)])],2))),128))])])]))}}),q=z(H,[["__scopeId","data-v-099b3cfc"]]);export{q as L,S as s};
