...
def init_app(app):
    from hiddifypanel import auth, g
    ...
    app.info = {
        ...
        "license": {"name": "Creative Commons Zero v1.0 Universal", "url": "https://github.com/hiddify/Hiddify-Manager/blob/main/LICENSE"},
    }
    ...
    # @app.spec_processor
    # def remove_proxy_path_param(spec):
    #     for path, path_item in spec["paths"].items():
    #         if "{proxy_path}" not in path:
    #             continue
    #         for method, operation in path_item.items():
    #             if "parameters" not in operation:
    #                 continue
    #             operation["parameters"] = [p for p in operation["parameters"] if p.get("name") != "proxy_path"]
    #     return spec
